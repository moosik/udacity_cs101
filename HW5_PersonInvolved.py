...
def involved(courses, person):
    ...
    for semester in courses:
       for Class in courses[semester]:
           for descriptors in courses[semester][Class]:
               if courses[semester][Class][descriptors]==person:
                   if semester in output:
                       output[semester].append(Class)
                   else:
                       output[semester]=[Class]
    return output
